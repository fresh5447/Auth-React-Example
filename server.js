...
app.post('/api/user', function(req,res){
  ...
  // If No User Create Account.
    // Search Subscribers to see if User exists.
      // If User exists add Subscriber ID to user object.
      // If Subscriber does not exist - post new user to Griz
      // Save subscriber ID to User.
